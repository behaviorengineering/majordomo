...
git clone --recurse-submodules ssh://git@bitbucket.srv.westpac.com.au/.../<your-app-repo>.git
```
...
git submodule add --force ssh://git@bitbucket.srv.westpac.com.au/a01a0f/majordomo.git .majordomo
