...
return [
        registry: [
            pullDomain:    '<package-registry-pull-domain>',
            pullUrl:       'https://<package-registry-pull-domain>',
            pushDomain:    '<package-registry-push-domain>',
        ...
        credentials: [
            package-registryCredentialsId:    '<jenkins-package-registry-username-password-credential-id>',
