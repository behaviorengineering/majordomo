...
func Run(opts Options) error {
	...
	case "bitbucket":
		return publishBitbucket(ctx, opts, summary)
	default:
...
func httpJSON(ctx context.Context, client *http.Client, method, url, token string, body any) (map[string]any, int, error) {
