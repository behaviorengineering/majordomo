...
//   <docker-registry-creds>          - Username/password for package registry Docker registry
//   <package-registry-token-creds>        - REGISTRY_USER + REGISTRY_TOKEN for BuildKit secrets
...
@groovy.transform.Field
final String JENKINS_AGENT_LABEL = 'linux-shared-agent'
...
def ensureImages(Map cfg, Map deps) {
    ...
    withCredentials([
        ...
        usernamePassword(credentialsId: cfg.credentials.package-registryCredentialsId,
