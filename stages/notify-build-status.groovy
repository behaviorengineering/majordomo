...
private static String _getCorpCaCertUrl() {
    'https://artifactory.srv.westpac.com.au/artifactory/wdp-001_generic/au/com/westpac/security/certificates/20241001/cacert-20241001.pem'
}
        ...
        withCredentials([string(credentialsId: bitbucketTokenCredentialsId, variable: 'BITBUCKET_TOKEN')]) {
            ...
            withEnv([
                ...
                sh """
                    ...
                    # Non-fatal: if Artifactory is unreachable the cert won't be mounted and
