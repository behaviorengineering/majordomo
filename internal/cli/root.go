...
func newContextCmd() *cobra.Command {
	...
	digest.Flags().StringVar(&digestFromStage, "from-stage", "", "stage start: catalog|intervention|story (with --resume-pr; refine still accepted); survey|catalog|intervention|story (with --local-seed-dir)")
