...
import (
	...
	diffpkg "github.com/behaviorengineering/majordomo/pkg/review/diff"
	...
	"github.com/behaviorengineering/majordomo/pkg/review/poll"
	"github.com/behaviorengineering/majordomo/pkg/review/report"
	"github.com/behaviorengineering/majordomo/pkg/review/reviewrun"
...
func newDispatchCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			switch {
			case finalize:
				mode = dispatch.ModeFinalize
			case summary:
				mode = dispatch.ModeSummary
			case score:
				mode = dispatch.ModeScore
			case technical:
				mode = dispatch.ModeTechnical
			case techScore:
				mode = dispatch.ModeTechScore
			case prose:
				mode = dispatch.ModeProse
			case techDeep:
...
func newContextCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "context",
		Short: "Served-repo context branch (validate; digest lives in majordomo-context)",
	}
	var dir string
	...
	var gateWorkDir, gateDir string
	gate := &cobra.Command{
		Use:   "gate",
