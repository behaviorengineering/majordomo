...
The username defaults to ARTIFACTORY_USER environment variable if omitted.
"""
...
def _run_credential_verification(
    ...
    checks: list[tuple[str, str]] = [
        ...
        (
            ...
            cfg.credentials.artifactory_credentials_id,
        ),
        (
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--username",
        metavar="USER",
        help="Jenkins username (env: ARTIFACTORY_USER).",
    )
    parser.add_argument(
        "--api-token",
...
def main() -> None:
    ...
    if not username or not args.api_token:
        print(
            ...
            "(or env vars ARTIFACTORY_USER / JENKINS_API_TOKEN) "
